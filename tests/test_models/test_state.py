...
class TestState(unittest.TestCase):
    ...
    def test_state_object_creation_with_name_attribute(self):
        state = State(name="California")
        self.assertEqual(state.name, "California")

    # State object name attribute can be an empty string
    def test_state_object_name_attribute_empty_string(self):
        state = State(name="")
        self.assertEqual(state.name, "")


class testStateIstnti(unittest.TestCase):
...
class TestStte_saving(unittest.TestCase):
...
class TestState_to_dictMethond(unittest.TestCase):
    ...
    def test_contrast_to_dict___er_dict(self):
        st = State()
