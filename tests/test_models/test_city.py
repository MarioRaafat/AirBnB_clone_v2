...
class TestCity(unittest.TestCase):
    ...
    # City object can be created with non-string state_id and name attributes
    # City object attributes can be accessed and modified
    ...
    # City object attributes can be accessed and modified
    def test_city_attributes_access_and_modification(self):
        city = City(state_id="123", name="New York")
        self.assertEqual(city.state_id, "123")
        self.assertEqual(city.name, "New York")
    ...
    # City object attributes can be set later using direct assignment
    ...
    # City object attributes can be set later using setattr() function
    def test_set_attributes_with_setattr(self):
        city = City()
        setattr(city, "state_id", "123")
        setattr(city, "name", "New York")
        self.assertEqual(city.state_id, "123")
        self.assertEqual(city.name, "New York")

    # City object can be created with a unique id attribute
    def test_city_creation_with_attributes(self):
        city = City(state_id="123", name="New York")
        self.assertEqual(city.state_id, "123")
        self.assertEqual(city.name, "New York")
...
class TesCitytInst(unittest.TestCase):
...
class TestCitSavging(unittest.TestCase):
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(cy.to_dict(), dictt)
